...
ALTER TABLE `stockmanager`.`Agendamento` 
ADD COLUMN `titulo` VARCHAR(500) NULL DEFAULT NULL AFTER `funcionario_id`,
CHANGE COLUMN `Funcionario_id` `funcionario_id` INT(11) NOT NULL ,
CHANGE COLUMN `Descricao` `descricao` TEXT NULL DEFAULT NULL ,
CHANGE COLUMN `Data` `data` DATETIME NOT NULL ,
CHANGE COLUMN `Estado` `estado` CHAR(1) NOT NULL ;