...
public class Insercao  implements java.io.Serializable {
    ...
    public Insercao(int id, Funcionario funcionario, Date data, byte[] nfe, char ativo) {
        this.id = id;
    ...
    public Insercao(int id, Funcionario funcionario, Date data, byte[] nfe, char ativo, Set<EstoqueHasProduto> estoqueHasProdutos) {
       this.id = id;
       this.funcionario = funcionario;
       this.data = data;
       this.nfe = nfe;
